...
from map_editor.walls_test3 import add_walls, add_boxes, dimensions


class MyMaptest3(MapAbstract):
    ...
    def __init__(self, zones_config: ZonesConfig = ()):
        ...
        self._rescue_center = RescueCenter(size=(84, 247))
        self._rescue_center_pos = ((338, 153), 0)

        self._return_area = ReturnArea(size=(186, 278))
        self._return_area_pos = ((304, 155), 0)

        self._wounded_persons_pos = [(347, -171), (-311, -230)]
        self._number_wounded_persons = len(self._wounded_persons_pos)
        self._wounded_persons: List[WoundedPerson] = []

        self._drones_pos = [(pos, random.uniform(-math.pi, math.pi)) for pos in [(244, 189), (249, 148)]]
