...
from map_editor.walls_KillZoneTest import add_walls, add_boxes, dimensions


class MyMapKillZoneTest(MapAbstract):
    ...
    def __init__(self, zones_config: ZonesConfig = ()):
        ...
        self._rescue_center = RescueCenter(size=(147, 76))
        self._rescue_center_pos = ((0, -159), 0)

        self._return_area = ReturnArea(size=(152, 69))
        self._return_area_pos = ((-2, -72), 0)

        self._kill_zone = KillZone(size=(151, 96))
        self._kill_zone_pos = ((32, 118), 0)

        self._wounded_persons_pos = [(127, 296),(100,200)]

        self._number_wounded_persons = len(self._wounded_persons_pos)
        self._wounded_persons: List[WoundedPerson] = []

        self._drones_pos = [(pos, random.uniform(-math.pi, math.pi)) for pos in [(-2, -75),(-10,-100)]]
