...
from map_editor.walls_test2 import add_walls, add_boxes, dimensions


class MyMaptest2(MapAbstract):
    ...
    def __init__(self, zones_config: ZonesConfig = ()):
        ...
        self._return_area = ReturnArea(size=(242, 106))
        self._return_area_pos = ((265, 236), 0)

        self._rescue_center = RescueCenter(size=(119, 95))
        self._rescue_center_pos = ((68, 235), 0)

        self._wounded_persons_pos = [(-285, -30), (329, -182)]
        self._number_wounded_persons = len(self._wounded_persons_pos)
        self._wounded_persons: List[WoundedPerson] = []

        self._drones_pos = [(pos, random.uniform(-math.pi, math.pi)) for pos in [(155, 262), (320, 254)]]
