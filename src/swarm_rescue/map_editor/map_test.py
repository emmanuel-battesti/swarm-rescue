...
from map_editor.walls_test import add_walls, add_boxes, dimensions
...
class MyMaptest(MapAbstract):
    ...
    def __init__(self, zones_config: ZonesConfig = ()):
        ...
        self._rescue_center = RescueCenter(size=(203, 101))
        self._rescue_center_pos = ((283, -235), 0)

        self._return_area = ReturnArea(size=(137, 110))
        self._return_area_pos = ((87, 0), 0)

        self._wounded_persons_pos = [(-341, -242), (-338, 38), (316, 251)]
        self._number_wounded_persons = len(self._wounded_persons_pos)
        self._wounded_persons: List[WoundedPerson] = []

        self._drones_pos = [(pos, random.uniform(-math.pi, math.pi)) for pos in [(258, 3)]]
