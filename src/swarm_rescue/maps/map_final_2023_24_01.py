...
from swarm_rescue.maps.walls_final_2023_24_01 import add_walls, add_boxes


class MapFinal_2023_24_01(MapAbstract):
...
def main():
    ...
    eval_config = EvalConfig(map_name="MapFinal_2023_24_01", zones_config=zones_config)
