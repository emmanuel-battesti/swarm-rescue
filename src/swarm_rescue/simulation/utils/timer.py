...
class Timer:
    ...
    def __init__(self, start_now: bool = False):
        ...
        Args:
            start_now (bool): If True, start the timer immediately.
        """
        ...
        self._state: StateTimer = StateTimer.stopped
    ...
    def get_elapsed_time_in_milliseconds(self) -> float:
    ...
    def print(self, txt: str) -> None:
        ...
        Args:
            txt (str): Description of the process.
        """
