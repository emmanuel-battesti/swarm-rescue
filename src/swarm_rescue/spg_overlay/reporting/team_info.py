...
class TeamInfo:
    """
        The TeamInfo class is responsible for parsing a YAML file containing
        team information and storing the data in its fields. It also prints out
         the team's name, number, and members.
    """
    ...
    def __init__(self):
        ...
        self.team_number_str = str(self.team_number).zfill(2)
