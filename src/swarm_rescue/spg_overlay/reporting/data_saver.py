...
class DataSaver:
    ...
    Attributes:
        ...
        _pdf_report: An instance of the EvaluationPdfReport class used for
    ...
    def __init__(self, team_info, enabled=True):
        ...
        for storing the results. It also
        ...
        self.stats_filename = (self._path +
                               f"/stats_team_{self._team_number_str}.csv")
    ...
    def save_images(self, im, im_explo_lines, im_explo_zones, map_name: str,
        ...
        filename = (f"{self.path}/"
                    ...
                    f"_rd{num_round_str}"
                    f"_team{self._team_number_str}.png")
